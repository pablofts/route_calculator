...
Calculates the shortest route that goes through a list of places. The input is an array containing the coordinates of each place the route should go by. The output is an array containing the distances and times between places and a link to display the route in google maps.
...
* Have a credit card.
* Create a billing acount in google console.
...
# Usage
* a_input module: within the vba text editor, you will need to provide an array with the places list in the in "listmtx" variable.
